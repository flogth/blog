  ...
  (list
   ...
   (section
    ...
    (p "Next to this site I also have a "
       (ll #:href "https://wwwcip.cs.fau.de/~oc45ujef"
   ...
   (section
    ...
    (p "This website is generated using a collection of racket scripts based on the great "
       (ll #:href "https://docs.racket-lang.org/scribble"
           #:name (code "#lang scribble")
           #:external #t)
       " , though I only use it as a library for generating html from s-expressions."
       " Find the source " (ll #:href "https://github.com/flodobeutlin/blog"
                               #:name "here"
                               #:external #t) ".")
    (p "The color scheme(s) are shamelessly ripped of emacs's "
       (ll #:href "https://github.com/protesilaos/modus-themes"
